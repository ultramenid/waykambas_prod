...
@section('content')
    ...
    <div class="max-w-2xl mx-auto px-4 mt-28">
        <h1 class="flex justify-center sm:text-5xl text-4xl font-bold text-center">Kinerja 2023</h1>
     ...
     <div class="max-w-5xl mx-auto px-4 sm:mt-16 mt-4">
        <div>
            <h1 class="text-green-600 text-3xl font-satunya font-bold">RENCANA KERJA TAHUNAN</h1>
        ...
        <div class="flex flex-row  scrollbar-hide overflow-x-scroll h-full   gap-4  md:mt-12 mt-6 snap-x snap-mandatory">
            <div class="sm:flex-shrink flex-shrink-0 snap-center sm:w-4/12 w-9/12 ">
                <h1 class="text-green-600 text-2xl font-satunya font-bold mb-2">LAPORAN TRIWULAN III</h1>
            ...
            <div class="sm:flex-shrink flex-shrink-0 snap-center sm:w-4/12 w-9/12">
                <h1 class="text-green-600 text-2xl font-satunya font-bold mb-2">LAPORAN TRIWULAN II</h1>
                <div class="  border border-gray-300">
                    <img
                    class="w-full h-52 object-cover object-center"
                    src="{{ asset('img/restorasi.jpeg') }}"
            ...
            <div class="sm:flex-shrink flex-shrink-0 snap-center sm:w-4/12 w-9/12">
                <h1 class="text-green-600 text-2xl font-satunya font-bold mb-2">LAPORAN TRIWULAN I</h1>
                <div class="  border border-gray-300">
                    <img
                    class="w-full h-52 object-cover object-center"
                    src="{{ asset('img/restorasi.jpeg') }}"
