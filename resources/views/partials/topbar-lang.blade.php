 ...
 <header class="bg-green-ndpe sticky top-0 z-50 font-satunya">
    <div x-data="{ open: false }" class="px-4 py-2 bg-black z-20 sm:hidden block">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2 z-50 font-satunya">
                <a href="{{ route(Route::currentRouteName(), 'en') }}"  class="cursor-pointer @if(App::getLocale() == 'en') text-white font-bold @else text-gray-500 @endif">EN</a>
                <div class="border-l border-white"></div>
                <a href="{{ route(Route::currentRouteName(), 'id') }}"  class="cursor-pointer @if(App::getLocale() == 'id') text-white font-bold @else text-gray-500 @endif">ID</a>
            </div>
        </div>
        ...
        x-cloak style="display: none !important">
            <button class="absolute px-4 py-2 focus:outline-none text-gray-300" @click="open = false">
            ...
            <div class="mt-12 space-y-3">
                ...
                <div class=" px-4">
                    <a href="{{ route('azrestoration', app()->getlocale() )}}" class="mb-4 px-4 inline-block text-base leading-5 text-gray-300 font-semibold uppercase">A to Z Restorasi Kadut<a>
                    <p class="border-b border-gray-300"></p>
                </div>
                {{-- <div class=" px-4">
                ...
                <div class=" px-4">
                    <a href="{{ route('story', app()->getlocale() )}}"class="mb-4 px-4 inline-block text-base leading-5 text-gray-300 font-semibold uppercase">Feature<a>
                    <p class="border-b border-gray-300"></p>
                </div>
                <div class=" px-4">
