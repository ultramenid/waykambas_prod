 <!-- hero -->
    <!-- image -->
    <div class=" bg-black sm:block hidden">
        <div class="max-w-5xl mx-auto px-4 flex justify-between items-center py-1">
            <div class="flex space-x-4 text-right">

            </div>
            <div class="flex space-x-2 text-gray-300 text-sm font-satunya">
