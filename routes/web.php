...
Route::group(['prefix' => '{lang}'], function () {
    ...
    Route::get('/about/who-we-are', [WhowheareController::class, 'index'])->name('whoweare');
    Route::get('/about/way-kambas', [WaykambasController::class, 'index'])->name('waykambas');
    Route::get('/about/restorasi-kadut', [RawakadutController::class, 'index'])->name('rawakadut');
    ...
    Route::get('/Matikan_api_menjaga_puspa', [MatikanAPiController::class, 'newMatikanapi'])->name('Matikan_api_menjaga_puspa');


    Route::get('/new-aducepat', [AducepatdirawakadutController::class, 'newAducepat'])->name('new-aducepat');
    Route::get('/new-matikanapi', [MatikanAPiController::class, 'newMatikanapi'])->name('new-matikanapi');
